    ...
    ui(new Ui::login)
{
    ...
    setWindowTitle("login section");
    ui->pass->setStyleSheet("border: 2px solid #cccccc; background-color: #f9f9f9; font-family: Arial; font-size: 12px;");
    ui->Uname->setStyleSheet("border: 2px solid #cccccc; background-color: #f9f9f9; font-family: Arial; font-size: 12px;");
    ui->pushButton->setStyleSheet("background-color: #FF0000; color: white;");
