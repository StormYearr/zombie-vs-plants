...
z1::z1()
{
    ...
    connect(timer, &QTimer::timeout, this, &z1::moveItem);
    timer->start(100); // Adjust interval as needed (milliseconds)
}
...
void z1::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
...
void z1::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void z1::hoverEnterEvent(QGraphicsSceneHoverEvent *event)
{
...
void z1::hoverLeaveEvent(QGraphicsSceneHoverEvent *event)
{
...
void z1::increaseScore(int amount)
{
    score += amount;
    if (score > 100)
    {
