...
z6::z6()
{
    ...
    connect(timer, &QTimer::timeout, this, &z6::moveItem);
...
void z6::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
...
void z6::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void z6::hoverEnterEvent(QGraphicsSceneHoverEvent *event)
{
...
void z6::hoverLeaveEvent(QGraphicsSceneHoverEvent *event)
{
...
void z6::increaseScore(int amount)
{
    score += amount;
    if (score > 100)
    {
