...
z3::z3()
{
    ...
    connect(timer, &QTimer::timeout, this, &z3::moveItem);
...
void z3::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
...
void z3::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void z3::hoverEnterEvent(QGraphicsSceneHoverEvent *event)
{
...
void z3::hoverLeaveEvent(QGraphicsSceneHoverEvent *event)
{
...
void z3::increaseScore(int amount)
{
    score += amount;
    if (score > 100)
    {
