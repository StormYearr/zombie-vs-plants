...
z5::z5()
{
    ...
    connect(timer, &QTimer::timeout, this, &z5::moveItem);
...
void z5::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
...
void z5::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void z5::hoverEnterEvent(QGraphicsSceneHoverEvent *event)
{
...
void z5::hoverLeaveEvent(QGraphicsSceneHoverEvent *event)
{
...
void z5::increaseScore(int amount)
{
    score += amount;
    if (score > 100)
    {
